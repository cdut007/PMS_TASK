...
public class RollingPlan implements Serializable{
	...
	public String getQualityplanno() {
		return this.qualityplanno;
	}

	public void setWeldlistno(String weldlistno) {
		this.weldlistno = weldlistno;
	}

	public String getWeldlistno() {
		return this.weldlistno;
	}
