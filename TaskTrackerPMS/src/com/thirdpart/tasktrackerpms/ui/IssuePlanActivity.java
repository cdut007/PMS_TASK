...
public class IssuePlanActivity extends BaseEditActivity  {
		...
		final  List<WidgetItemInfo> itemInfos = new ArrayList<WidgetItemInfo>();
		 ...
		 itemInfos.add(new WidgetItemInfo("0", null, null, 0, false));		
		  ...
		  FragmentManager fm = getSupportFragmentManager();
			...
			mFragment = fm.findFragmentByTag(IssuePlanListFragment.class.getName());
			if (mFragment == null) {
				Bundle bundle = new Bundle();
				bundle.putLong(ConstValues.ID, Long.parseLong(rollingPlan.getId()));
				mFragment = IssuePlanListFragment.instantiate(this, IssuePlanListFragment.class.getName(), bundle);
				ft.add(R.id.fragment_content, mFragment, IssuePlanListFragment.class.getName());
			}
